...
class ConvDataType:
    def string_to_float(self, string, caller_title, help=None):
        try:
            result = float(string)
        except:
            raise TypeError(
    ...
    def string_to_int(self, string, caller_title, help=None):
        try:
            result = int(string)
        except:
            raise TypeError(
    ...
    def string_to_bool(self, string, caller_title, help=None):
