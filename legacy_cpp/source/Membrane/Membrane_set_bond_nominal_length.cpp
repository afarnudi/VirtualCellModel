...
void Membrane::set_bond_nominal_length(void){
    ...
    if (Node_Bond_Nominal_Length_stat=="Au") {
        ...
        for (int i=0; i<Num_of_Node_Pairs; i++) {
            Node_Bond_Nominal_Length_in_Nm[i] = sqrt( (Node_Position[Node_Bond_list[i][0]][0]-Node_Position[Node_Bond_list[i][1]][0])*(Node_Position[Node_Bond_list[i][0]][0]-Node_Position[Node_Bond_list[i][1]][0]) +
