...
axes[0,0].plot(time,memrg, label='Rg mem', color='orange')
# =============================================================================

p = calc_pressure(traj_data, vel_data)
p=p/memrg3

axes[0,1].plot(time,p, label='Pressure', color='green')
# =============================================================================
...
axes[1,0].set_title("Chromatin Rg")
...
axes[1,1].plot(time, volume_fraction, label='rho')
# =============================================================================
