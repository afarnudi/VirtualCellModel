...
void Chromatin::Thermostat_Bussi(double MD_T){
    update_COM_velocity();
...
void Chromatin::Thermostat_2(double MD_T){
    update_COM_velocity();
    ...
    alpha=sqrt(MD_T/Kinetic_energy);
    for(int i=0;i<Num_of_Nodes;i++)
    {
        Node_Velocity [i][0]*=alpha;
        Node_Velocity [i][1]*=alpha;
...
void Chromatin::Thermostat_N6(double MD_T){
