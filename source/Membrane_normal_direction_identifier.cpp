...
void Membrane::Membrane_Normal_direction_Identifier(double x, double y, double z)
{
    ...
    for(  int i=0;i<Membrane_triangle_list.size();i++)
    {
        ...
        reference[0]=Membrane_Node_Position[Point_A][0]-x;
        reference[1]=Membrane_Node_Position[Point_A][1]-y;
        reference[2]=Membrane_Node_Position[Point_A][2]-z;
