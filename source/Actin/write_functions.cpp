...
void Actin::generate_report()
{
    ...
    Report<<"Num_of_Actins"<<std::setw(20)<<GenConst::Num_of_Actins<<endl;
    ...
    if (spring_model==0)
    {
        Report<<"Actin Spring Model:"<< std::setw(20)<<"Hookian"<<endl;
    }
    if (spring_model==2)
    {
        Report<<"Actin Spring Model:"<< std::setw(20)<<"Kelvin"<<endl;
    }
