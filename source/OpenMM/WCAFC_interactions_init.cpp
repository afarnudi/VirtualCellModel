...
void init_WCAFC_interaction(vector<OpenMM::CustomNonbondedForce*> &WCAFCs,
    ...
    WCAFCs[index]->addGlobalParameter(sigma,    atoms[*it_1].radius+atoms[*it_2].radius );
    ...
    WCAFCs[index]-> setCutoffDistance( 1.1224620483 * (atoms[*it_1].radius+atoms[*it_2].radius));
    


    WCAFCs[index]-> addInteractionGroup(set_1[set_1_index], set_2[set_2_index]);
}
...
void init_WCAFC_interaction(vector<OpenMM::CustomNonbondedForce*> &WCAFCs,
    ...
    if (use_max_radius) {
        WCAFCs[index]->addGlobalParameter(sigma,   2*max( atoms[*it_1].radius
                                                                 , atoms[*it_2].radius ) );
    } else {
        WCAFCs[index]->addGlobalParameter(sigma,   ( atoms[*it_1].radius
                                                                 + atoms[*it_2].radius ) );
    }
    ...
    if (use_max_radius) {
        WCAFCs[index]-> setCutoffDistance( pow(2, 1./6) * 2 * max( atoms[*it_1].radius
                                                          , atoms[*it_2].radius ) );
    } else {
        WCAFCs[index]-> setCutoffDistance( pow(2, 1./6) *( atoms[*it_1].radius
                                                        + atoms[*it_2].radius ) );
    }
    
    WCAFCs[index]-> addInteractionGroup(compined_set, set_2[set_2_index]);
}
...
void init_WCAFC_interaction(vector<OpenMM::CustomNonbondedForce*> &WCAFCs,
    ...
    WCAFCs[index]-> addInteractionGroup(compined_set_1, compined_set_2);
}
