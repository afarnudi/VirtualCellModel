...
//                step(area_0-area)
                ...
                string potential = epsilon+"*("+to_string(int(pow(2, 12)))+"*("+area_0+"/"+area+")^12-"+to_string(int(pow(2, 6)))+"*("+area_0+"/"+area+")^6+0.25)*step("+to_string(triangles[i].surface_WCA_min_area*pow(2,1./6.))+"-"+area+")";
