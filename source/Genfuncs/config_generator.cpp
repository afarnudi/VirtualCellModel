...
void configfile_generator(int status){
    ...
    if (status==0) {
        ...
        if (comments) {
            ...
            write_configs<<"#WCA: Weeks-Chandler-Andersen potential."<<endl;
        ...
        write_configs<<"C0  WCA  0  LJ  0"<<endl;
        write_configs<<endl;
        if (comments) {
            write_configs<<"#Example of an interaction map with multiple calsses."<<endl;
            write_configs<<"#    M0 M1 A0 A1 E0 C0  C1  C2  C3"<<endl;
            write_configs<<"#M0  WCA         "<<endl;
            write_configs<<"#M1  WCA WCA        "<<endl;
            write_configs<<"#A0  0   0   0     "<<endl;
            write_configs<<"#A1  0   0   0  0   "<<endl;
            write_configs<<"#E0  0   LJ  0  0  0"<<endl;
            write_configs<<"#C0  WCA WCA 0  0  0  WCA"<<endl;
            write_configs<<"#C1  WCA WCA 0  0  0  WCA  WCA"<<endl;
            write_configs<<"#C2  WCA WCA 0  0  0  WCA  WCA  WCA"<<endl;
            write_configs<<"#C3  WCA WCA 0  0  0  WCA  WCA  WCA  WCA"<<endl;
            write_configs<<"#Where:"<<endl;
            write_configs<<"#WCA interaction is set between all Chromatins and Membrane calsses. Also, the interaction is set for each class memeber, that is the Chromatin or Membrane nodes cannot cross themselves."<<endl;
