...
void ECM::write_traj (string traj_name, string label){
    ofstream Trajectory;
...
void ECM::generate_report()
{
    ...
    Report_file_name= "Results/Reports/Report_ECM_"+to_string(index)+"_";
    ...
    Report<<"Num_of_ECMs"<<setw(20)<<GenConst::Num_of_ECMs<<endl;
    ...
    if (spring_model==0)
    {
        Report<<"ECM Spring Model:"<< setw(20)<<"Hookian"<<endl;
    }
    if (spring_model==2)
    {
        Report<<"ECM Spring Model:"<< setw(20)<<"Kelvin"<<endl;
    }
