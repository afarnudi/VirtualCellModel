...
int main(){
    ...
    if (type==1)
    {
        ...
        vector<double> mass, radius, stiffness, bending, shift_x, shift_y , shift_z, vel_x, vel_y, vel_z, sigma_LJ, epsilon_LJ, f_x, f_y, f_z, kelvin_damp, contractile_k1, contractile_k2, contractile_force, contractile_hill_co, contractile_rmin, contractile_rmax, actin_r0, abp_spring_coefficient, abp_k1, abp_k2, abp_force, abp_hill_co, abp_rmin, abp_rmax, abp_r0  ;
        
        vector<int> spring_model, ext_force,class_type, contractile_model, abp_spring_model, abp_model;
        //int spring_model = 2;
